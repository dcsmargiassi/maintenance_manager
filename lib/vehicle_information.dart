          ...
          PopupMenuButton<String>(
            onSelected: (choice) {
              ...
              //if (choice == 'editVehicle'){
               // navigateToEditVehiclePage(context);
              //}
            },
            itemBuilder: (context) => [
              const PopupMenuItem(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              children:[
                SizedBox(height: screenWidth * 0.05, width: 5),
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Maintenance Record'),
                    ),
                    SizedBox(width: spacing),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async{
                        // Navigate to add edit vehicle page
                        navigateToEditVehiclePage(context, data.vehicleId!);
                      },
